...
public class Sphere extends Geometry {
    ...
    public boolean intersect(Ray inRay, Ray outRay) {
        ...
        double b = 2.0 * inRay.direction.dot(
                inRay.origin.x - position.x,
                inRay.origin.y - position.y,
                inRay.origin.z - position.z);
        
        double discriminant = b * b - 4.0 * (Vector.distSquared(inRay.origin, position) - radius * radius);
