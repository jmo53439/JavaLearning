...
public class GeneticAlgorithm extends JFrame {
    ...
    public void geneticAlgorithm() {
        ...
        for(generation = 0; generation < generations; generation++) {
            ...
            while(population.chromosomes.size() < population.populationLimit) {
                ...
                int i1 = random.nextInt(population.chromosomes.size());
                int i2 = (i1 + 1 + random.nextInt(population.chromosomes.size() - 1))
    ...
    int[][] crossOver(int[] p1, int[] p2) {
        ...
        int i2 = (i1 + 1 + random.nextInt(n - 1)) % n;
        int[] n1 = p1.clone();
        int[] n2 = p2.clone();
    ...
    void mutate(int[] p) {
        ...
        int j = (i + 1 + random.nextInt(n - 1)) % n;
            ...
            for(int i = 0; i < n; i++) {
                ...
                for(int j = 0; j < n; j++) {
                    ...
                    double delta =
                            ...
                            dist(x[res[i1]], y[res[i1]], x[res[j]], y[res[j]])
