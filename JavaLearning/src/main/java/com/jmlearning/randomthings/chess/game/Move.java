...
public class Move {
    ...
    public Move(char originFile, int originRank, char destinationFile, int destinationRank) {
        ...
        this.piece = Board
                .getSquare(originFile, originRank)
                .getCurrentPiece();
        this.capturedPiece = Board
                .getSquare(destinationFile, destinationRank)
                .getCurrentPiece();
    ...
    public Move(Piece piece, char originFile, int originRank,
    ...
    public Move(Piece piece, Piece capturedPiece, char originFile, int originRank,
                char destinationFile, int destinationRank) {
