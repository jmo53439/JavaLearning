...
import com.jmlearning.randomthings.gamingprogramming.sound.AudioStream;
import com.jmlearning.randomthings.gamingprogramming.sound.SoundEvent;
...
public class QuickRestart extends SoundEvent {
    ...
    protected void processEvent(String event) throws InterruptedException {
        ...
        System.out.println("Quick Restart was: " + event);
