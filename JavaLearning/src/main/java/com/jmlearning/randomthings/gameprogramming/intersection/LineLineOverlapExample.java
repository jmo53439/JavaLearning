...
public class LineLineOverlapExample extends SimpleFramework {
    ...
    private boolean lineLineOverlap(Vector2f A, Vector2f B, Vector2f P, Vector2f Q) {
        ...
        Vector2f C0 = A.add(B).divide(2.0f);
        Vector2f C1 = P.add(Q).divide(2.0f);
        Vector2f C = C0.subtract(C1);
        Vector2f r0 = A.subtract(C0);
        Vector2f r1 = P.subtract(C1);
    ...
    protected void render(Graphics g) {
        ...
        Vector2f v0 = view.multiply(P);
        Vector2f v1 = view.multiply(Q);
        g.drawLine((int) v0.x, (int) v0.y, (int) v1.x, (int) v1.y);
        v0 = view.multiply(start);
        v1 = view.multiply(end);
        g.drawLine((int) v0.x, (int) v0.y, (int) v1.x, (int) v1.y);
    }
