...
public class ScaleImageExample extends SimpleFramework {
    ...
    protected void initialize() {
        ...
        System.out.println("Generating Bi-Linear");
        start = System.nanoTime();
        ...
        System.out.println("Generating Bi-Cubic");
        start = System.nanoTime();
        ...
        System.out.println("Generating Step Down Bi-Linear");
        start = System.nanoTime();
        ...
        System.out.println("Generating Step Down Bi-Cubic");
        start = System.nanoTime();
    ...
    protected void render(Graphics g) {
        ...
        // test image
        g.drawImage(sprite, (canvas.getWidth() - sprite.getWidth()) / 2,
                50, null);
        ...
        g.drawString("Area Average", 50, textPos + 15);
        ...
        g.drawString("Bi-Linear", imgPos, textPos + 15);
        g.drawString(time, imgPos, textPos + 30);
        ...
        g.drawString("Bi-Cubic", imgPos, textPos + 15);
        g.drawString(time, imgPos, textPos + 30);
        ...
        g.drawString("Bi-Linear Step", imgPos, textPos + 15);
        g.drawString(time, imgPos, textPos + 30);
        ...
        g.drawString("Bi-Cubic Step", imgPos, textPos + 15);
        g.drawString(time, imgPos, textPos + 30);
    }
