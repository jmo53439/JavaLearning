...
public class SafeKeyboardFramework extends JFrame implements Runnable {
    ...
    protected void render(Graphics g) {
        ...
        frameRate.calculate();
        textPosition = Utility.drawString(g, 20, 0, frameRate.getFrameRate());
    }
