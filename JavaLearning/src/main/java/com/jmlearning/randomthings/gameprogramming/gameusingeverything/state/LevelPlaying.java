...
import com.jmlearning.randomthings.gamingprogramming.gameusingeverything.object.*;
...
public class LevelPlaying extends State {
    ...
    private void updateBullet(float delta, Bullet bullet) {
        ...
        if(wrapper.hasLeftWorld(bullet.getPosition())) {
            ...
            ArrayList<Asteroid> ast = new ArrayList <>(asteroids);
    ...
    private void updateAsteroidExplosions(float delta) {
        ...
        for(AsteroidExplosion explosion :
                new ArrayList <AsteroidExplosion>(explosions)) {
