...
public class PolarCoordinateExample extends JFrame implements Runnable {
    ...
    protected void gui() {
       ...
       setTitle("Polar Coordinates Example");
    ...
    private void render(Graphics g) {
        ...
        g.setColor(Color.GREEN);
        g.drawLine(cx, cy, coordinate.x, coordinate.y);
        int px = coordinate.x - cx;
        int py = cy - coordinate.y;
        ...
        g.drawString(String.format("(%s,%s)", px, py), coordinate.x, coordinate.y);
    ...
    private void processInput() {
        ...
        coordinate = mouse.getMousePosition();
    }
