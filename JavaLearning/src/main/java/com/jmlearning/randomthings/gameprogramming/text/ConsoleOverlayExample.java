...
public class ConsoleOverlayExample extends SimpleFramework {
    ...
    protected void initialize() {
        ...
        text.add("Press [Space] to move text.");
        ...
        console = new BufferedImage(
                canvas.getWidth() - 40, consoleHeight, BufferedImage.TYPE_INT_ARGB);
        xConsole = 20;
        yConsole = 50;
        hide = false;
        hidden = 1.0f;
    ...
    protected void processInput(float delta) {
        ...
        Point position = mouse.getMousePosition();
        int minX = xConsole;
        int minY = yConsole;
    ...
    protected void updateObjects(float delta) {
        ...
        if(boxes) {
            ...
            g.drawRect(0, fontHeight * text.size(),
        ...
        if(hidden > 0.0f) {
            ...
            // clear right
            g.fillRect(console.getWidth() - xHide, 0,
            ...
            // clear bottom
            g.fillRect(0, console.getHeight() - yHide,
                    console.getWidth(), console.getHeight());
        }
