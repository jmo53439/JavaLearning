...
public class CircleLineIntersectionExample extends SimpleFramework {
    ...
    private void drawLine(Graphics g, Vector2f p0, Vector2f p1) {
        ...
        Vector2f p0Cpy = view.multiply(p0);
        Vector2f p1Cpy = view.multiply(p1);
    ...
    private void drawIntersections(
        ...
        if(planeIntersection != null) {
            ...
            Vector2f intCpy = view.multiply(planeIntersection);
        ...
        if(lineIntersection != null) {
            ...
            Vector2f intCpy = view.multiply(lineIntersection);
